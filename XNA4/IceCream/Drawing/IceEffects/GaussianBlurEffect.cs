...
namespace IceCream.Drawing.IceEffects
{
    public class GaussianBlurEffect : IceEffect
    {
        ...
        {           
            ...
            // Pass 1: draw the buffer (rt A) into rendertarget B,
            ...
            //DrawingManager.RenderTargetManager.SaveTexture(DrawingManager.CurrentRenderTarget, "E:/cbeforeGauss.png");
            ...
            // Pass 2: draw from rendertarget B back into the rt A,
            ...
            GraphicsDevice.Clear(new Color(0, 0, 0, 255));
            //DrawingManager.RenderTargetManager.SaveTexture(RenderTargetInstance.EffectA, "E:/afterGauss.png");
