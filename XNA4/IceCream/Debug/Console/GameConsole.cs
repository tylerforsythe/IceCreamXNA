    ...
    public class GameConsole : DrawableGameComponent, IGameConsole
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            VertexPositionColorTexture[] vertices = new VertexPositionColorTexture[]
            {
                ...
                new VertexPositionColorTexture(new Vector3(graphics.GraphicsDevice.Viewport.Width, 0, 0), color, new Vector2(1, 0)),
                new VertexPositionColorTexture(new Vector3(graphics.GraphicsDevice.Viewport.Width, height, 0), color, new Vector2(1, 1)),
                new VertexPositionColorTexture(new Vector3(0, height, 0), color, new Vector2(0, 1)),
            };
            //VertexPositionColor[] vertices = new VertexPositionColor[]
            //{
            //    new VertexPositionColor(new Vector3(0, 0, 0), color),
            //    new VertexPositionColor(new Vector3(graphics.GraphicsDevice.Viewport.Width, 0, 0), color),
            //    new VertexPositionColor(new Vector3(graphics.GraphicsDevice.Viewport.Width, height, 0), color),
            //    new VertexPositionColor(new Vector3(0, height, 0), color),
            //};

            // create indices for the background quad (triangle points 0, 1, 2, second triangle 2, 3, 0)
            ...
            if (mDrawCursor)
            {
                ...
                VertexPositionColorTexture[] cursorverts = new VertexPositionColorTexture[]
                {
                    new VertexPositionColorTexture(new Vector3(cursorpos, position.Y, 0), color, new Vector2()),
                    new VertexPositionColorTexture(new Vector3(cursorpos, position.Y + mFontHeight, 0), color, new Vector2()),
                };
            ...
            if (mDrawNotify && (mCurrentLine < mLog.Count - 1))
            {
                ...
                VertexPositionColorTexture[] notifyverts = new VertexPositionColorTexture[]
                {
                    new VertexPositionColorTexture(new Vector3(0, yofs, 0), color, new Vector2()),
                    new VertexPositionColorTexture(new Vector3(graphics.GraphicsDevice.Viewport.Width, yofs, 0), color, new Vector2()),
                };
        ...
        public void Log(string message)
        {
            ...
            ConsoleMessage msg = new ConsoleMessage(mDefaultLogLevel, mCurrentTime.TotalGameTime,
                DateTime.Now.TimeOfDay, message);
            mLog.Add(msg);
